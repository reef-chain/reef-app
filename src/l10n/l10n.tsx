...
export const localizedStrings = new LocalizedStrings({
  en: {
    ...
    buy_reef_options_title: 'Choose how you want to buy REEF',
    buy_reef_option_token_to_token: 'Crypto to Reef',
    buy_reef_option_token_to_token_description: 'Swap tokens to REEF using LetsExchange.',
    buy_reef_option_fiat_to_token: 'Fiat to Reef',
    buy_reef_option_fiat_to_token_description: 'Buy REEF with card or bank transfer using Alchemy Pay.',
    ...
    staking_bond_unbond: 'Bond / Unbond',
    staking_bond: 'Bond',
    staking_unbond: 'Unbond',
    staking_rebond: 'Rebond',
    staking_chill: 'Chill',
    staking_bond_success: 'Bond submitted',
    staking_bond_error: 'Bond failed',
    staking_unbond_success: 'Unbond submitted',
    staking_unbond_error: 'Unbond failed',
    staking_rebond_success: 'Rebond submitted',
    staking_rebond_error: 'Rebond failed',
  ...
  hi: {
    ...
    buy_reef_options_title: 'चुनें कि आप REEF कैसे खरीदना चाहते हैं',
    buy_reef_option_token_to_token: 'क्रिप्टो से रीफ',
    buy_reef_option_token_to_token_description: 'LetsExchange का उपयोग करके REEF में स्वैप करें।',
    buy_reef_option_fiat_to_token: 'फिएट से रीफ',
    buy_reef_option_fiat_to_token_description: 'Alchemy Pay का उपयोग करके कार्ड या बैंक ट्रांसफर से REEF खरीदें।',
    ...
    staking_bond_unbond: 'बॉन्ड / अनबॉन्ड',
    staking_bond: 'बॉन्ड',
    staking_unbond: 'अनबॉन्ड',
    staking_rebond: 'रीबॉन्ड',
    staking_chill: 'चिल',
    staking_bond_success: 'बॉन्ड भेजा गया',
    staking_bond_error: 'बॉन्ड असफल',
    staking_unbond_success: 'अनबॉन्ड भेजा गया',
    staking_unbond_error: 'अनबॉन्ड असफल',
    staking_rebond_success: 'रीबॉन्ड भेजा गया',
    staking_rebond_error: 'रीबॉन्ड असफल',
